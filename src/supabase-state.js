...
export async function readAppState(stateKey,fallback){
  if(!hasSupabaseConfig()) throw new Error('Supabase is required for Assurance Regent persistence. Configure SUPABASE_URL and SUPABASE_SECRET_KEY on the server.');
