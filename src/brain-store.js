...
async function readStore(){
  const v=await readAppState('system_brain',DEFAULT,{seedIfMissing:true});
  return { ...structuredClone(DEFAULT), ...v, threads: v?.threads && typeof v.threads==='object' ? v.threads : {} };
}
async function writeStore(v){await writeAppState('system_brain',v);return v;}
