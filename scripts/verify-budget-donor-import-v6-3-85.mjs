...
for(const token of ['assurance_regent_budget_import_batches','assurance_regent_budget_import_projects','assurance_regent_budget_import_rates','assurance_regent_budget_import_rules','PENDING_FINANCE_REVIEW','PENDING_COUNTRY_DIRECTOR','security definer','enable row level security','activeBudgets','activeRates','ar_budget_import_superseded_by_idx','v_month_end','v_month_start'])if(!sqlText.includes(token))throw new Error(`Migration is missing v6.3.85 token: ${token}`);
