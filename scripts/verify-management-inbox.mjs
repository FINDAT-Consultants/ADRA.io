...
if(!html.includes('work-inbox.css?v=6.3.27'))throw new Error('Base internal inbox stylesheet is not linked.');
...
console.log('[management-inbox-verify] OK: Messages sits between Notifications and Documents with private recipients, unread badge and attachments.');
console.log('[management-inbox-verify] OK: ordinary Jivan chat is isolated from the Inbox.');
