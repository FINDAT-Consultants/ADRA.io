...
if (!/<dialog\b[^>]*\bid=["']controlRegisterDialog["']/iu.test(html)) {
  throw new Error('Published sign-up dialog is missing.');
}
...
console.log(`[auth-entry-bootstrap] published independent interactive login guard v=${version}.`);
