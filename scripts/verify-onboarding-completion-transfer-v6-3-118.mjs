...
console.log(`[verify-onboarding-completion-transfer-v6-3-118] OK apps=${targets.filter(existsSync).length} active-queue-only=1 capture-phase=1 drain-save-queue=1 authoritative-readback=1 retry-until-confirmed=1 employee-transfer=1 candidate-hired=1 auto-open-employees=1 sri-bindings=${sriBindings}`);
