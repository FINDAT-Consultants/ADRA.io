...
for(const token of ['BUDGET_PERSONNEL_SCHEMA87','Personnel Directory','Developer account is excluded','EMPLOYEE','Template downloaded ·'])if(!app.includes(token))throw new Error(`Built app is missing budget personnel v6.3.87 token: ${token}`);
