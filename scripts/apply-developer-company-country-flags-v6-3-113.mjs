...
const publicApps=targets.filter(file=>file.startsWith(`${publicDir}/`)&&existsSync(file)&&statSync(file).isFile()),appNames=new Set(publicApps.map(file=>basename(file)));let sriUpdated=0;
