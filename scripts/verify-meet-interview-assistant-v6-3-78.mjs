...
if(app.includes('await gmailWaitForConnection77(popup);'))throw new Error('Meet authorization must wait for the Meet scope, not merely an already-connected Gmail account.');
