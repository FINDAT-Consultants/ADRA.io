-- Assurance Regent v6.3.9 HOTFIX 1 — Corrected complete Supabase setup
-- Fresh-install script. Runs all required migrations in dependency order.
...
-- ===== v6.3.13 recruitment enhancement =====
...
-- v6.3.17 profile persistence hotfix (included for fresh installs)
